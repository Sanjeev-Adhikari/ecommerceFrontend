      ...
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div className="flex mb-4">
          <span className="flex items-center">
            ...
            <span className="text-gray-600 ml-3">{reviews?.length}</span>
          </span>
        ...
        <p className="leading-relaxed"><span style={{color : "green", fontWeight:700}}>Status</span> : {product?.productStatus}</p>
        <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-200 mb-5">
        <p className="leading-relaxed"><span style={{color : "green", fontWeight:700}}>Stock left</span> : {product?.productStockQty}</p>
        </div>
        <div className="flex">
...

         {
          product?.productStockQty > 0 ? (
            <button
            className=" flex ml-auto   py-2 px-6 hover:bg-yellow-500 hover:text-white border-2 border-gray-900 rounded-full focus:outline-none" onClick={handleCart}>Add
       to cart</button>
          ) :
          <button
            className=" flex ml-auto   py-2 px-6 hover:bg-yellow-500 hover:text-white border-2 border-gray-900 rounded-full focus:outline-none">Out of Stock</button>
         }
